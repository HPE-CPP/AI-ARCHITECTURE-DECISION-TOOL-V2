...
from fastapi import UploadFile, File, HTTPException, Query, BackgroundTasks
...
def health():
    return {"status": "ok", "version": settings.APP_VERSION,"extraction_cache_entries": extraction_cache.size,}
